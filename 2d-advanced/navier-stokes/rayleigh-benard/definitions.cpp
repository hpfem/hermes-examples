...
public:
  WeakFormRayleighBenard(double Pr, double Ra, std::string bdy_top, double temp_ext, double alpha_air,
    ...
    add_matrix_form(new DefaultMatrixFormVol<double>(0, 0, new Hermes2DFunction<double>(1./time_step)));
    // Laplacian divided by Pr in the first velocity equation.
    add_matrix_form(new DefaultJacobianDiffusion<double>(0, 0, new Hermes1DFunction<double>(1./Pr)));
    ...
    add_matrix_form(new DefaultMatrixFormVol<double>(1, 1, new Hermes2DFunction<double>(1./time_step)));
    // Laplacian divided by Pr in the second velocity equation.
    add_matrix_form(new DefaultJacobianDiffusion<double>(1, 1, new Hermes1DFunction<double>(1./Pr)));
    ...
    add_matrix_form(new DefaultMatrixFormVol<double>(1, 3, new Hermes2DFunction<double>(Ra * Pr)));

    /* Jacobian terms - temperature equation */
    // Time derivative in the temperature equation.
    add_matrix_form(new DefaultMatrixFormVol<double>(3, 3, new Hermes2DFunction<double>(1./time_step)));
    ...
    add_matrix_form_surf(new DefaultMatrixFormSurf<double>(3, 3, new Hermes2DFunction<double>(alpha_air), bdy_top));
    ...
    add_vector_form(F_3);
    add_vector_form_surf(new DefaultVectorFormSurf<double>(3, new Hermes2DFunction<double>(-alpha_air * temp_ext), bdy_top));
