...
{
  // Jacobian - volumetric.
  add_matrix_form(new WeakFormsH1::DefaultJacobianDiffusion<double>(0, 0, HERMES_ANY, new Hermes1DFunction<double>(d_TT/c_TT), HERMES_NONSYM, HERMES_AXISYM_Y));
  ...
  add_matrix_form(new WeakFormsH1::DefaultJacobianDiffusion<double>(1, 1, HERMES_ANY, new Hermes1DFunction<double>(d_ww/c_ww), HERMES_NONSYM, HERMES_AXISYM_Y));
